...
namespace SystemInterface.Dynamics.Crm
{
	public class MaterialeBehovDefinition : AbstractCrm
	{
		...
		public static List<MaterialeBehovDefinition> FindMaterialeBehovDefinitionPerMateriale(DynamicsCrmConnection dynamicsCrmConnection, Guid materialeId, Func<string, string> getResourcePath)
		{
			...
			List<MaterialeBehovDefinition> definitioner = StaticCrm.ReadFromFetchXml(dynamicsCrmConnection, xDocument, (connection, lEntity) => new MaterialeBehovDefinition(connection, lEntity));
