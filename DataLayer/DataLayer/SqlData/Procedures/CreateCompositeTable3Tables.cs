...
{
	internal static class CreateCompositeTable3Tables
	{
		...
		private static void DeleteProcedure(SqlConnection sqlConnection)
		{
			...
			sqlStringBuilder.AppendLine("			objects.name = 'CreateCompositeTable3Tables'");
			sqlStringBuilder.AppendLine("	)");
			sqlStringBuilder.AppendLine(")");
			sqlStringBuilder.AppendLine("BEGIN");
			sqlStringBuilder.AppendLine("	DROP PROCEDURE CreateCompositeTable3Tables");
		...
		private static void CreateProcedure(SqlConnection sqlConnection)
		{
			...
			sqlStringBuilder.AppendLine("	CreateCompositeTable3Tables");
			...
			sqlStringBuilder.AppendLine("	,@primaryKeyName3 NVARCHAR(128)");
			...
			sqlStringBuilder.AppendLine("		,'+QUOTENAME(@primaryKeyName3)+' UNIQUEIDENTIFIER NOT NULL");
			sqlStringBuilder.AppendLine("		,PRIMARY KEY ('+QUOTENAME(@primaryKeyName1)+','+QUOTENAME(@primaryKeyName2)+','+QUOTENAME(@primaryKeyName3)+')");
			sqlStringBuilder.AppendLine("	)'");
			sqlStringBuilder.AppendLine("");
			sqlStringBuilder.AppendLine("");
			...
			sqlStringBuilder.AppendLine("	BEGIN");
			sqlStringBuilder.AppendLine("		EXEC SP_EXECUTESQL @sql, N'@tablename NVARCHAR(128), @primaryKeyName1 NVARCHAR(128), @primaryKeyName2 NVARCHAR(128), @primaryKeyName3 NVARCHAR(128)', @tablename = @tablename, @primaryKeyName1 = @primaryKeyName1, @primaryKeyName2 = @primaryKeyName2, @primaryKeyName3 = @primaryKeyName3");
			sqlStringBuilder.AppendLine("	END");
			sqlStringBuilder.AppendLine("END");
