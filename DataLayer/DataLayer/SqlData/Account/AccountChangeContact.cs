...
namespace DataLayer.SqlData.Account
{
	public class AccountChangeContact : AbstractData
	{
		...
		{
			List<Guid> relatedIds = SqlUtilities.ReadNNTable(sqlConnection, typeof(AccountChangeContact), "AccountChangeId", "ContactId", accountChangeId);
		...
		{
			List<Guid> relatedIds = SqlUtilities.ReadNNTable(sqlConnection, typeof(AccountChangeContact), "ContactId", "AccountChangeId", contactId);
