...
namespace DataLayer.MongoData.Option.Options.Logic
{
	public class SynchronizeFromCsv : OptionBase
	{
		...
		public string dateStringOverride { get; set; }
		...
		public static SynchronizeFromCsv Create(MongoConnection connection, string name, Schedule schedule, Guid changeProviderId, string fileName, string fileNameTmp, char delimeter, string keyName, string dateName, string mappingField, string[] fields, string dateStringOverride, ImportTypeEnum importType)
		{
