...
namespace Administration.Option.Options.Logic
{
	public class SynchronizeFromCrm : AbstractDataOptionBase
	{
		...
		{
			List<Group> externalAccountIdsFromAccountContact = crmContact.GetExternalGroupsFromContactGroup();
			List<DatabaseGroup> DatabaseGroups = externalAccountIdsFromAccountContact.Select(group => DatabaseGroup.ReadByNameOrCreate(SqlConnection, group.Name)).ToList();
